  ...
  data() {
    return {
      images: [
        ...
        { src: "https://owwny-b2b-base-files.s3.us-east-1.amazonaws.com/websites/bella-vista/kidsV4.jpg", alt: "Juegos infantiles", title: "Juegos infantiles", description: "Para los más pequeños, diversión sin fin. Un área pensada para que ellos jueguen, se diviertan y creen recuerdos inolvidables." },
