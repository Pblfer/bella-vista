<template>
  <div class="bg-primary border-four md:flex grid justify-center md:flex-row px-[4%] mt-4" id="respaldo">
    ...
    <div class="relative w-full  justify-end flex flex-col gap-2">
  ...
  <div
    ...
    <p class="text-xs tracking-wide text-primary text-center md:text-center">Powered by <a target="_blank"
        href="https://owwny.com" class="font-black">Owwny Inc.</a></p>
    <div
