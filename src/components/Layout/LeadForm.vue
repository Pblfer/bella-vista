      ...
      <div>
        <div class="lg:mt-12 mt-10 flex justify-center">
          ...
          >
            <label
              for="name"
              class="text-md absolute -top-5  left-0 -mt-2 inline-block text-white font-thin tracking-widest text-a1"
              >Nombre</label
            >
            <input
              type="text"
          ...
          <div class="mt-10 flex justify-end md:mt-12">
            <button
              v-if="!showLoading && checkData == false"
            ...
            >
              <svg
                ...
                stroke-width="1.5"
                stroke="currentColor"
                class="mr-2 mt-0.5 h-6 w-6 animate-spin"
              >
                <path
...
.vue-country-intl-input::placeholder, .vue-country-intl-input::-webkit-input-placeholder, .vue-country-intl-input::-moz-placeholder {
