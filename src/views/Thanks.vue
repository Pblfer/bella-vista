<template>
    <div class="h-screen bg-secondary">
      ...
      <div class="mt-8 flex justify-center">
        <router-link
          to="/"
          class="mb-12 flex w-auto rounded-sm bg-primary py-3 px-8 text-xl font-semibold tracking-wider text-secondary hover:bg-four hover:text-white  md:text-xl"
        >
          <svg
       ...
       <div>
          <div class="flex justify-center">
                <div class="flex gap-2 p-4">
                  ...
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    class="ml-4 mr-2 h-7 w-7 fill-primary hover:fill-four"
                    viewBox="0 0 448 512"
                  >
                  ...
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    class="mt-0.5 h-6 w-6 fill-primary hover:fill-four"
                    viewBox="0 0 512 512"
                  >
                    <!--! Font Awesome Pro 6.1.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
                    <path
